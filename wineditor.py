...
if is_admin():
    ...
    # - enable defender -
    def enabledefender():
        os.system(r'reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender" /v "DisableAntiVirus" /t "REG_DWORD" /d "0" /f')
    ...
    # - disable defender -
    def disabledefender():
        os.system(r'reg add "HKLM\SOFTWARE\Policies\Microsoft\Windows Defender" /v "DisableAntiVirus" /t "REG_DWORD" /d "1" /f')
    ...
    def rebootdefender():
        os.system("cls")
        restart = input("Windows Defender has been modified. Do you want to restart your PC to apply\nthe new setting? (Y/N): ")
        if restart == 'N':
    ...
    def rebootcortana():
        os.system("cls")
        restart = input("Cortana has been modified. Do you want to restart your PC to apply the new\nsetting? (Y/N): ")
        if restart == 'N':
            print("returning to main screen...")
            time.sleep(3)
            main()
    ...
    def rebootfeedback():
        os.system("cls")
        restart = input("Windows Feedback has been modified. Do you want to restart your PC to apply\nthe new setting? (Y/N): ")
        if restart == 'N':
            print("returning to main screen...")
            time.sleep(3)
            main()
    ...
    def rebootshutdown():
        os.system("cls")
        restart = input("Shutdown speed has been optimized. Do you want to restart your PC to apply\nthe new setting? (Y/N): ")
        if restart == 'N':
            print("returning to main screen...")
            time.sleep(3)
            main()
    ...
    def rebootstartup():
        os.system("cls")
        restart = input("Start-Up speed has been optified. Do you want to restart your PC to apply\nthe new setting? (Y/N): ")
        if restart == 'N':
            print("returning to main screen...")
            time.sleep(3)
            main()
    ...
    def rebootsecnotifs():
        os.system("cls")
        restart = input("Windows Security Notifs have been changed. Do you want to restart your PC to\napply the new setting? (Y/N): ")
        if restart == 'N':
            print("returning to main screen...")
            time.sleep(3)
            main()
    ...
    def main():
        os.system("cls")
        print("   Welcome to wineditor v1 by milu")
        print("=====================================")
